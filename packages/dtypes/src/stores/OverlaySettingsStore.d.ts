...
export interface OverlaySettingsStore {
    ...
    getDisabledSettingByNotificationType(...args: any[]): any;
    ...
    isNotificationDisabledBySetting(...args: any[]): any;
...
export declare const OverlaySettingsStore: OverlaySettingsStore;
